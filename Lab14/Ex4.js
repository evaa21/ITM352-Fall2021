...
//add a new user
username = 'newuser';
user_data[username] = {};  //new empty object for that attribute
user_data[username].password = 'newpass'; //Fill in the password 
user_data[username].email = 'newuser@user.com'; //and email adress
